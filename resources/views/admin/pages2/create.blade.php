    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="{{ route('store.pages2')}}" method="post" class="form-horizontal" enctype="multipart/form-data" >    
            @csrf
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select data-placeholder="Choose Category" class="span11" required="" name="type" >
                  ...
                  <option value="1">উপজেলা সম্পর্কে</option>
                  <option value="2">অন্যান্য তথ্য</option>
                </select>
              </div>
            </div>
